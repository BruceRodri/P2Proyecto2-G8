    ...
    <div className={styles.page}>
      ...
      <div className={styles.grid}>
        <div className={styles.card}>
          ...
          <a href="mailto:contacto@mathstats.com" className={styles.link}>contacto@mathstats.com</a>
        </div>

        <div className={styles.card}>
          <FiGithub className={styles.icon} />
          <h2>GitHub</h2>
          <a href="https://github.com/mathstats" target="_blank" rel="noopener noreferrer" className={styles.link}>
            github.com/mathstats
          </a>
        </div>
